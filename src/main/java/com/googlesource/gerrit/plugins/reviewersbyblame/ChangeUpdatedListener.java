...
class ChangeUpdatedListener implements EventListener {
  ...
  private final ChangeData.Factory cangeDataFactory;
  ...
  ChangeUpdatedListener(
      ...
      ChangeData.Factory cangeDataFactory,
      PluginConfigFactory cfg,
      @PluginName String pluginName) {
    this.reviewersByBlameFactory = reviewersByBlameFactory;
    this.repoManager = repoManager;
    this.cangeDataFactory = cangeDataFactory;
  ...
  public void onEvent(Event event) {
    ...
    try (Repository git = repoManager.openRepository(projectName);
      ...
      ChangeData changeData = cangeDataFactory.create(projectName, changeId);
