...
@Singleton
public class ReviewersByBlameAction
  ...
  @Inject
  ReviewersByBlameAction(final PermissionBackend permissionBackend) {
    this.permissionBackend = permissionBackend;
  }

  @Override
  public Response<?> apply(RevisionResource rsrc, ReviewersByBlameAction.Input input)
