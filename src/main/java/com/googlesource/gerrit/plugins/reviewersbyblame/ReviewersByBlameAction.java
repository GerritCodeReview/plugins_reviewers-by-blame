...
@Singleton
public class ReviewersByBlameAction extends RetryingRestModifyView<RevisionResource, ReviewersByBlameAction.Input, ChangeInfo>
    implements RestModifyView<RevisionResource, ReviewersByBlameAction.Input>, UiAction<RevisionResource> {
  ...
  protected Response<?> applyImpl(
      BatchUpdate.Factory updateFactory, RevisionResource rsrc, ReviewersByBlameAction.Input input)
    ...
    try (Repository git = repoManager.openRepository(projectName);
      ...
      final Runnable task =
          reviewersByBlameFactory.create(commit, changeCd, ps, maxReviewers, git, ignoreFileRegEx);
