...
@Singleton
public class ReviewersByBlameRevisionAction
    implements RestModifyView<RevisionResource, ReviewersByBlameRevisionAction.Input> {
  private static final Logger log = LoggerFactory.getLogger(ReviewersByBlameRevisionAction.class);
  ...
  @Inject
  ReviewersByBlameRevisionAction(
  ...
  @Override
  public Response<?> apply(RevisionResource rsrc, ReviewersByBlameRevisionAction.Input input)
      throws IOException, RestApiException, OrmException {
